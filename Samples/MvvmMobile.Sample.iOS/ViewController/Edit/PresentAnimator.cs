...
{
    public class PresentAnimator : UIViewControllerAnimatedTransitioning, ITransitionAnimator
    {
        ...
        public override void AnimateTransition(IUIViewControllerContextTransitioning transitionContext)
        {
            ...
            var fromView = _sourceViewController.GetViewForSnapshot(_destinationViewController.GetType(), ViewControllerTransitioningAnimatorPresentationType.Present);
            var toView = _destinationViewController.GetViewForSnapshot(_sourceViewController.GetType(), ViewControllerTransitioningAnimatorPresentationType.Present);
            ...
            // Calculate
            var fromViewSnapshotView = fromView.SnapshotView(false);
            ...
            toView.Alpha = 0;
            toView.Frame = fromViewSnapshotView.Frame;
